...
public class HighlightCombinedRenderer extends CombinedChartRenderer {
    ...
    public HighlightCombinedRenderer(CombinedChart chart,
            ...
            switch (order) {
                case BAR:
                    if (chart.getBarData() != null){
                        mRenderers.add(
                                new HighlightBarRenderer(chart, mAnimator, mViewPortHandler)
...
//                        mRenderers.add(new BarChartRenderer(chart, mAnimator, mViewPortHandler));
                ...
                case LINE:
                    if (chart.getLineData() != null){
                        mRenderers.add(
                                new HighlightLineRenderer(chart, mAnimator, mViewPortHandler)
                                        .setHighlightSize(highlightSize)
                ...
                case CANDLE:
                    if (chart.getCandleData() != null){
                        mRenderers.add(
                                new HighlightCandleRenderer(chart, mAnimator, mViewPortHandler)
                                        .setHighlightSize(highlightSize)
                        );
                    }
                    break;
