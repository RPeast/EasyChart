...
public class MyCoupleChartGestureListener implements OnChartGestureListener {
    ...
    private MyChartGesture myChartGesture;

    public MyCoupleChartGestureListener(Chart srcChart, Chart[] dstCharts) {
        this.srcChart = srcChart;
        this.dstCharts = dstCharts;
    }

    public MyCoupleChartGestureListener(Chart srcChart, Chart[] dstCharts, MyChartGesture myChartGesture) {
        this.srcChart = srcChart;
        this.dstCharts = dstCharts;
        this.myChartGesture = myChartGesture;
    }
    @Override
...
//        Log.d("MyCoupleChartGestureListener", "onChartScale " + scaleX + " / " + scaleY + " X= " + me.getX() + " Y= " + me.getY());
        if (myChartGesture != null) {
            if (srcChart.getViewPortHandler().getScaleX() < 1.1) {
                myChartGesture.changeChartView(1);
            } else {
                myChartGesture.changeChartView(2);
            }
        }
        syncCharts();
    }
